...
class _LiabilitiesPageState extends State<LiabilitiesPage> {
  ...
  String _currentFilters() {
    ...
    return "ID='LIB'$methodFilter$statusFilter$nameFilter$invFilter$dateFilter";
  }
  ...
  Future<void> printSummaryReport() async {
    try {
      await AccountPrintService.printReport(
        title: 'Liability Account Summary',
        ...
        summary: {
          ...
          'Total Liability LKR': numberFormat(totalBalance),
        },
      );
    } catch (_) {}
  }
  ...
  Future<void> printLedgerReport() async {
    try {
      ...
      await AccountPrintService.printReport(
        title: 'Liability Account Ledger',
        ledgerData: data,
        numberFormat: numberFormat,
        columns: cols,
      );
